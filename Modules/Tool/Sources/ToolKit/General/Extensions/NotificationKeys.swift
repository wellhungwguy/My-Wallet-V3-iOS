...
extension Notification.Name {
    ...
    public static let kycFinished = Notification.Name("notification_kyc_status_did_finish")
    ...
    public static let debitCardRefresh = Notification.Name("notification_refresh_debit_card")
}

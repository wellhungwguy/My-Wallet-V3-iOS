...
final class EVMSupport: MoneyKit.EVMSupport {
    ...
    private lazy var sanitizeTokenNamesEnabledLazy: Bool = fetchBool(tag: blockchain.app.configuration.evm.name.sanitize.is.enabled)
